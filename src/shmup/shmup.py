...
#pacp_folder = os.path.join(img_dir, "Platformer Art Complete Pack")
...
class Player(pygame.sprite.Sprite):
    ...
    def hide(self):
        ...
        self.hidden = True
        self.hide_timer = pygame.time.get_ticks()
        self.rect.center = (WIDTH / 2, HEIGHT + 200)  # moves where it's "safe"
...
background = pygame.image.load(os.path.join(img_dir, "backgrounds/starfield.png")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(os.path.join(img_dir, "SpaceShooterRedux/PNG/playerShip1_orange.png")).convert()
player_mini_img = pygame.transform.scale(player_img, (25, 19))
player_mini_img.set_colorkey(BLACK)
# meteor_img = pygame.image.load(os.path.join(img_dir, "SpaceShooterRedux/PNG/Meteors/meteorBrown_med1.png")).convert()
bullet_img = pygame.image.load(os.path.join(img_dir, "SpaceShooterRedux/PNG/Lasers/laserRed16.png")).convert()
meteor_images = []
meteor_list = ["SpaceShooterRedux/PNG/Meteors/meteorBrown_big1.png",
...
explosion_anim = {}
explosion_anim['lg'] = [] # large animation
explosion_anim['sm'] = [] # small animation
explosion_anim['player'] = [] # small animation
for i in range(9):
...
powerup_images = {}
powerup_images['shield'] = pygame.image.load(os.path.join(img_dir, 'SpaceShooterRedux/PNG/Power-ups/shield_gold.png')).convert()
powerup_images['gun'] = pygame.image.load(os.path.join(img_dir, 'SpaceShooterRedux/PNG/Power-ups/bolt_gold.png')).convert()
